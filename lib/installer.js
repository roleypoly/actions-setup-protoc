...
function getProtoc(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!toolPath) {
            ...
            toolPath = yield acquireProtoc(version);
...
function acquireProtoc(version) {
    return __awaiter(this, void 0, void 0, function* () {
        //
        ...
        return yield tc.cacheDir(toolRoot, 'protoc', version);
    });
}
function getFileName(version) {
    const platform = osPlat == 'win32' ? 'win' : osPlat == 'darwin' ? 'osx-x86_' : 'linux-x86_';
